...
const Navbar = () => {
  ...
  return <>
      ...
      <nav className="flex justify-between items-center md:max-w-screen-lg mx-auto py-6">
        <div className="logo">
          <Link to="/">
          <img src="./fs-logo.jpg" className="h-[64px] w-[64px] rounded-full" alt="Fratello Studios Logo" />
          </Link>
        </div>
      ...
      {/* mobile navbar icon open and close  */}
        ...
        <div className={nav ? 'mobile-nav fixed md:hidden bg-black w-[60%] h-screen top-0 left-0 px-4 pt-6 ease-in-out duration-500 border-r border-r-gray-900' : "mobile-nav fixed md:hidden bg-black w-[60%] h-screen top-0 left-[-100%] px-4 pt-6 ease-in-out duration-500"}>
        <div className="logo">
          <Link to="/">
          <img src="./fs-logo.jpg" className="h-[64px] w-[64px] rounded-full" alt="Fratello Studios Logo" />
          </Link>
